  ...
  class ImageView extends Component {
    ...
    handleMouseDown = e => {
      ...
      if (e.target.className === "Line") {
        ...
        // for (let i = 0; i < e.target.attrs.points.length; i++) {
        //   console.log(i, " : ", e.target.attrs.points[i]);
        //   console.log({ polygon: e.target.attrs.points[i] });

        //   if (i % 2 === 0) {
        //     polygon.push((e.target.attrs.points[i] / e.currentTarget.attrs.width) * 100);
        //   } else {
        //     polygon.push((e.target.attrs.points[i] / e.currentTarget.attrs.height) * 100);
        //   }
        // }
        // console.log({ polygon });
        ...
        console.log({
          // keypoint: [
          //   (e.target.attrs.x / e.currentTarget.attrs.width) * 100,
          //   (e.target.attrs.y / e.currentTarget.attrs.height) * 100,
          // ],
          keypoint: [e.target.attrs.x, e.target.attrs.y],
        });
      } else if (e.target.className === "Rect") {
        // let centerX = (e.target.attrs.x + (e.target.attrs.height / 2))
        // let centerY = (e.target.attrs.y + (e.target.attrs.width / 2))
        // console.log("centerX :", centerX, "centerY :", centerY)
        const x1 = e.target.attrs.x;
        const y1 = e.target.attrs.y;
        const x2 = e.target.attrs.x + e.target.attrs.width;
        const y2 = e.target.attrs.y;
        const x3 = e.target.attrs.x;
        ...
        const rectangleArray = [x1, y1, x2, y2, x3, y3, x4, y4];

        // this.setState({
        //   // rectLocation: [
        //   //   (x1 / e.currentTarget.attrs.width) * 100,
        //   //   (y1 / e.currentTarget.attrs.height) * 100,
        //   //   (x2 / e.currentTarget.attrs.width) * 100,
        //   //   (y2 / e.currentTarget.attrs.height) * 100,
        //   //   (x3 / e.currentTarget.attrs.width) * 100,
        //   //   (y3 / e.currentTarget.attrs.height) * 100,
        //   //   (x4 / e.currentTarget.attrs.width) * 100,
        //   //   (y4 / e.currentTarget.attrs.height) * 100,
        //   // ],
        //   rectLocation: [x1, y1, x2, y2, x3, y3, x4, y4],
        // });
        // console.log({ rectLocation: this.state.rectLocation });
        console.log({ rectangle: rectangleArray });
      } else {
